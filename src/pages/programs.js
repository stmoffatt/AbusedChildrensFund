      ...
      <div>
        ...
        <div className="body">
          ...
          <div className="container">
            <div id="moreInfoTitle">
              <h3 id="moreInfoH3">More Information</h3>
            </div>
            <div class="columns">
              <div class="column is-half">
                <div className="extraImageContainer" id="imageLeft">
                  <img
                    className="image"
                    src="http://mediad.publicbroadcasting.net/p/kalw/files/styles/x_large/public/201712/bird.png"
                  />
                  <h3 className="columnTitle" id="moreInfoH3">
                    Fifth column
                  </h3>
                </div>
              </div>
